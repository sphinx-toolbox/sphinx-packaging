...
The ``sphinx-packaging`` source code is available on GitHub,
...
The recommended way to build ``sphinx-packaging`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
